...
const CATEGORY_KEYWORD_RULES = [
  ...
  { key: "souba", words: ["経済指標", "景気循環", "景気サイクル", "セクターローテーション", "セクター", "金利", "為替", "インフレ", "決算シーズン", "相場", "マクロ経済", "ニュースの読み方", "ニュース", "雇用統計", "テクニカル指標", "移動平均線", "MACD", "RSI", "ボリンジャーバンド", "標準偏差", "出来高", "オシレーター", "モメンタム", "チャート", "マクロ経済学", "ミクロ経済", "需要と供給", "GDP"] },
